...
export const normalizeToken = async (provider, zContract, currentToken, account) => {
  ...
  const tokenInst = new ethers.Contract(currentToken.tokenAddress, erc20Abi, provider);
  if(!tokenInst){
    return undefined;
  }

...
export declare namespace ZLend2Manual {
...
export interface ZLend2ManualInterface extends utils.Interface {
  functions: {
...
export interface ZLend2Manual extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZLend2ManualInterface;
  ...
  functions: {
    ...
    getTokenFrom(
      tokenAddress: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[ZLend2Manual.TokenStructOutput]>;
